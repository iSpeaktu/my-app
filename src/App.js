    ...
    <div className="min-h-screen bg-[#0A0A0C] text-white pb-32 selection:bg-[#00F2FF] selection:text-[#0A0A0C]">
      ...
      {view === 'ob_screen1' && (
        <div className="max-w-md mx-auto min-h-[90vh] flex flex-col items-center justify-center px-8 animate-in fade-in">
            <h2 className="text-2xl font-bold mb-10 text-center leading-snug">Do you study English with<br/><span className="text-[#00F2FF]">iSpeaktu lessons?</span></h2>
            <button onClick={() => setView('ob_screen2')} className="w-full p-6 bg-[#16161D] border border-[#2D2D3A] rounded-2xl mb-4 font-bold text-lg hover:border-[#00F2FF] transition-all">Yes, I have a track</button>
      ...
      {view === 'ob_screen2' && (
        <div className="max-w-md mx-auto py-10 px-8 animate-in slide-in-from-right-10">
            <h2 className="text-2xl font-bold mb-10 text-center">What is your track?</h2>
